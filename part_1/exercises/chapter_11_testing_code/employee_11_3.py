...
and test_give_custom_raise(). Write your tests once without using a fixture, and 
make sure they both pass. Then write a fixture so you don’t have to create a 
new employee instance in each test function. Run the tests again, 
and make sure both tests still pass.
"""

class Employee():
    """Store employees information and provides raise."""
    ...
    def give_raise(self, raise_amount=""):
        """add raise amount to salary. If no raise amount 5000 is add to salary by default"""
        if raise_amount:
