...
numbers until your ticket wins. Print a message reporting how many times the loop 
...
def get_winning_ticket(possibilities):
    """Returning a winning ticket from a set of possibilities"""
    winning_ticket = []

    # We don't want to repeat winning numbers or letters, so we use a while loop
...
def check_ticket(played_ticket, winning_ticket):
    # check all element in the played ticket. If any are not in the winning
    # ticket, return False.
