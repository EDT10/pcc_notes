...
print("\n---I lost the big table so now I can only invite 2 guests----")

print(f"Sorry {guest_list.pop()} you're no longer invited to dinner.\n")
print(f"Sorry {guest_list.pop()} you're no longer invited to dinner.\n")
print(f"Sorry {guest_list.pop()} you're no longer invited to dinner.\n")
print(f"Sorry {guest_list.pop()} you're no longer invited to dinner.\n")
print(f"Sorry {guest_list.pop()} you're no longer invited to dinner.\n")

print(f"{guest_list[0]} is still invited to the birthday dinner")
print(f"{guest_list[1]} is still invited to the birthday dinner")

#deleting every guest from the list so the list is empty
del guest_list[0]
del guest_list[0]
